...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(1) Baz FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Baz() : a_(), b_(0) {}
  Baz(uint8_t _b) : a_(), b_(::flatbuffers::EndianScalar(_b)) {}
...
inline bool operator!=(const Baz& lhs, const Baz& rhs) { return !(lhs == rhs); }
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Bar FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Bar() : a_(), b_(0), padding0__(0), padding1__(0) {
    (void)padding0__;
    (void)padding1__;
  }
  Bar(uint8_t _b)
  ...
  Bar(::flatbuffers::span<const float, 3> _a, uint8_t _b)
      : b_(::flatbuffers::EndianScalar(_b)), padding0__(0), padding1__(0) {
    ::flatbuffers::CastToArray(a_).CopyFromSpan(_a);
    (void)padding0__;
    (void)padding1__;
  }
...
inline bool operator!=(const Bar& lhs, const Bar& rhs) { return !(lhs == rhs); }
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Color FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Color() : rgb_(), tag_(0), padding0__(0), padding1__(0) {
    (void)padding0__;
    (void)padding1__;
  }
  Color(uint8_t _tag)
  ...
  Color(::flatbuffers::span<const float, 3> _rgb, uint8_t _tag)
      : tag_(::flatbuffers::EndianScalar(_tag)), padding0__(0), padding1__(0) {
  ...
  uint8_t tag() const { return ::flatbuffers::EndianScalar(tag_); }
  void mutate_tag(uint8_t _tag) { ::flatbuffers::WriteScalar(&tag_, _tag); }
};
FLATBUFFERS_STRUCT_END(Color, 16);

inline bool operator==(const Color& lhs, const Color& rhs) {
  return (*lhs.rgb() == *rhs.rgb()) && (lhs.tag() == rhs.tag());
}
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Apple FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Apple() : tag_(0), padding0__(0), padding1__(0), color_() {
    (void)padding0__;
    (void)padding1__;
  }
  ...
  uint8_t tag() const { return ::flatbuffers::EndianScalar(tag_); }
  void mutate_tag(uint8_t _tag) { ::flatbuffers::WriteScalar(&tag_, _tag); }
  const keyfield::sample::Color& color() const { return color_; }
  keyfield::sample::Color& mutable_color() { return color_; }
  ...
  int KeyCompareWithValue(const keyfield::sample::Color& _color) const {
    ...
    const auto rgb_compare_result =
        lhs_color.KeyCompareWithValue(rhs_color_rgb);
    if (rgb_compare_result != 0) return rgb_compare_result;
    const auto lhs_color_tag = lhs_color.tag();
    const auto rhs_color_tag = rhs_color.tag();
    if (lhs_color_tag != rhs_color_tag)
      return static_cast<int>(lhs_color_tag > rhs_color_tag) -
             static_cast<int>(lhs_color_tag < rhs_color_tag);
    return 0;
  }
};
...
inline bool operator==(const Apple& lhs, const Apple& rhs) {
  return (lhs.tag() == rhs.tag()) && (lhs.color() == rhs.color());
}
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Fruit FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Fruit() : a_(), b_(0), padding0__(0), padding1__(0) {
    (void)padding0__;
    (void)padding1__;
  }
  ...
  const keyfield::sample::Apple& a() const { return a_; }
  keyfield::sample::Apple& mutable_a() { return a_; }
  ...
  int KeyCompareWithValue(const keyfield::sample::Apple& _a) const {
    ...
    if (lhs_a_tag != rhs_a_tag)
      return static_cast<int>(lhs_a_tag > rhs_a_tag) -
             static_cast<int>(lhs_a_tag < rhs_a_tag);
    const auto rhs_a_color = rhs_a.color();
    const auto color_compare_result = lhs_a.KeyCompareWithValue(rhs_a_color);
    if (color_compare_result != 0) return color_compare_result;
    return 0;
  }
  uint8_t b() const { return ::flatbuffers::EndianScalar(b_); }
  void mutate_b(uint8_t _b) { ::flatbuffers::WriteScalar(&b_, _b); }
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Rice FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Rice() : origin_(), padding0__(0), quantity_(0) { (void)padding0__; }
  ...
  Rice(::flatbuffers::span<const uint8_t, 3> _origin, uint32_t _quantity)
      : padding0__(0), quantity_(::flatbuffers::EndianScalar(_quantity)) {
  ...
  uint32_t quantity() const { return ::flatbuffers::EndianScalar(quantity_); }
...
inline bool operator==(const Rice& lhs, const Rice& rhs) {
  return (*lhs.origin() == *rhs.origin()) && (lhs.quantity() == rhs.quantity());
}
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Grain FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Grain() : a_(), tag_(0), padding0__(0), padding1__(0) {
    (void)padding0__;
    (void)padding1__;
  }
  Grain(uint8_t _tag)
  ...
  int KeyCompareWithValue(
      const ::flatbuffers::Array<keyfield::sample::Rice, 3>* _a) const {
    ...
    for (::flatbuffers::uoffset_t i = 0; i < curr_a->size(); i++) {
      ...
      for (::flatbuffers::uoffset_t i = 0; i < lhs_a_origin->size(); i++) {
        ...
        if (lhs_a_origin_elem != rhs_a_origin_elem)
          return static_cast<int>(lhs_a_origin_elem > rhs_a_origin_elem) -
                 static_cast<int>(lhs_a_origin_elem < rhs_a_origin_elem);
      }
      const auto lhs_a_quantity = lhs_a.quantity();
      const auto rhs_a_quantity = rhs_a.quantity();
      if (lhs_a_quantity != rhs_a_quantity)
        return static_cast<int>(lhs_a_quantity > rhs_a_quantity) -
               static_cast<int>(lhs_a_quantity < rhs_a_quantity);
    }
    return 0;
  }
  uint8_t tag() const { return ::flatbuffers::EndianScalar(tag_); }
...
inline bool operator==(const Grain& lhs, const Grain& rhs) {
  return (*lhs.a() == *rhs.a()) && (lhs.tag() == rhs.tag());
}
...
struct FooTable FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_b(int32_t _b = 0) { return SetField<int32_t>(VT_B, _b, 0); }
  ...
  const ::flatbuffers::Vector<const keyfield::sample::Baz*>* d() const {
    return GetPointer<
        const ::flatbuffers::Vector<const keyfield::sample::Baz*>*>(VT_D);
  }
  ::flatbuffers::Vector<const keyfield::sample::Baz*>* mutable_d() {
    return GetPointer<::flatbuffers::Vector<const keyfield::sample::Baz*>*>(
        VT_D);
  }
  const ::flatbuffers::Vector<const keyfield::sample::Bar*>* e() const {
    return GetPointer<
        const ::flatbuffers::Vector<const keyfield::sample::Bar*>*>(VT_E);
  }
  ::flatbuffers::Vector<const keyfield::sample::Bar*>* mutable_e() {
    return GetPointer<::flatbuffers::Vector<const keyfield::sample::Bar*>*>(
        VT_E);
  }
  const ::flatbuffers::Vector<const keyfield::sample::Apple*>* f() const {
    return GetPointer<
        const ::flatbuffers::Vector<const keyfield::sample::Apple*>*>(VT_F);
  }
  ::flatbuffers::Vector<const keyfield::sample::Apple*>* mutable_f() {
    return GetPointer<::flatbuffers::Vector<const keyfield::sample::Apple*>*>(
        VT_F);
  }
  const ::flatbuffers::Vector<const keyfield::sample::Fruit*>* g() const {
    return GetPointer<
        const ::flatbuffers::Vector<const keyfield::sample::Fruit*>*>(VT_G);
  }
  ::flatbuffers::Vector<const keyfield::sample::Fruit*>* mutable_g() {
    return GetPointer<::flatbuffers::Vector<const keyfield::sample::Fruit*>*>(
        VT_G);
  }
  const ::flatbuffers::Vector<const keyfield::sample::Grain*>* h() const {
    return GetPointer<
        const ::flatbuffers::Vector<const keyfield::sample::Grain*>*>(VT_H);
  }
  ::flatbuffers::Vector<const keyfield::sample::Grain*>* mutable_h() {
    return GetPointer<::flatbuffers::Vector<const keyfield::sample::Grain*>*>(
        VT_H);
  }
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffsetRequired(verifier, VT_C) && verifier.VerifyString(c()) &&
           VerifyOffset(verifier, VT_D) && verifier.VerifyVector(d()) &&
           VerifyOffset(verifier, VT_E) && verifier.VerifyVector(e()) &&
           VerifyOffset(verifier, VT_F) && verifier.VerifyVector(f()) &&
  ...
  void UnPackTo(
      FooTableT* _o,
      const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
  static ::flatbuffers::Offset<FooTable> Pack(
      ::flatbuffers::FlatBufferBuilder& _fbb, const FooTableT* _o,
...
struct FooTableBuilder {
  ...
  void add_a(int32_t a) { fbb_.AddElement<int32_t>(FooTable::VT_A, a, 0); }
  void add_b(int32_t b) { fbb_.AddElement<int32_t>(FooTable::VT_B, b, 0); }
  void add_c(::flatbuffers::Offset<::flatbuffers::String> c) {
    fbb_.AddOffset(FooTable::VT_C, c);
  }
  void add_d(
      ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Baz*>>
          d) {
    fbb_.AddOffset(FooTable::VT_D, d);
  }
  void add_e(
      ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Bar*>>
          e) {
    fbb_.AddOffset(FooTable::VT_E, e);
  }
  void add_f(::flatbuffers::Offset<
             ::flatbuffers::Vector<const keyfield::sample::Apple*>>
                 f) {
    fbb_.AddOffset(FooTable::VT_F, f);
  }
  void add_g(::flatbuffers::Offset<
             ::flatbuffers::Vector<const keyfield::sample::Fruit*>>
                 g) {
    fbb_.AddOffset(FooTable::VT_G, g);
  }
  void add_h(::flatbuffers::Offset<
             ::flatbuffers::Vector<const keyfield::sample::Grain*>>
                 h) {
...
inline ::flatbuffers::Offset<FooTable> CreateFooTable(
    ::flatbuffers::FlatBufferBuilder& _fbb, int32_t a = 0, int32_t b = 0,
    ::flatbuffers::Offset<::flatbuffers::String> c = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Baz*>>
        d = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Bar*>>
        e = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Apple*>>
        f = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Fruit*>>
        g = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const keyfield::sample::Grain*>>
        h = 0) {
...
inline ::flatbuffers::Offset<FooTable> CreateFooTableDirect(
    ::flatbuffers::FlatBufferBuilder& _fbb, int32_t a = 0, int32_t b = 0,
    const char* c = nullptr, std::vector<keyfield::sample::Baz>* d = nullptr,
  ...
  auto f__ =
      f ? _fbb.CreateVectorOfSortedStructs<keyfield::sample::Apple>(f) : 0;
  auto g__ =
      g ? _fbb.CreateVectorOfSortedStructs<keyfield::sample::Fruit>(g) : 0;
  auto h__ =
      h ? _fbb.CreateVectorOfSortedStructs<keyfield::sample::Grain>(h) : 0;
  return keyfield::sample::CreateFooTable(_fbb, a, b, c__, d__, e__, f__, g__,
                                          h__);
}

::flatbuffers::Offset<FooTable> CreateFooTable(
    ::flatbuffers::FlatBufferBuilder& _fbb, const FooTableT* _o,
    const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
...
inline FooTableT* FooTable::UnPack(
...
inline void FooTable::UnPackTo(
    FooTableT* _o, const ::flatbuffers::resolver_function_t* _resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = a();
...
inline ::flatbuffers::Offset<FooTable> FooTable::Pack(
    ::flatbuffers::FlatBufferBuilder& _fbb, const FooTableT* _o,
...
inline ::flatbuffers::Offset<FooTable> CreateFooTable(
  ...
  return keyfield::sample::CreateFooTable(_fbb, _a, _b, _c, _d, _e, _f, _g, _h);
}

inline const ::flatbuffers::TypeTable* BazTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_UCHAR, 1, -1}, {::flatbuffers::ET_UCHAR, 0, -1}};
...
inline const ::flatbuffers::TypeTable* BarTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_FLOAT, 1, -1}, {::flatbuffers::ET_UCHAR, 0, -1}};
  static const int16_t array_sizes[] = {
      3,
  };
...
inline const ::flatbuffers::TypeTable* ColorTypeTable() {
  ...
  static const int64_t values[] = {0, 12, 16};
  static const char* const names[] = {"rgb", "tag"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_STRUCT,
                                              2,
                                              type_codes,
                                              nullptr,
...
inline const ::flatbuffers::TypeTable* AppleTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_UCHAR, 0, -1}, {::flatbuffers::ET_SEQUENCE, 0, 0}};
  static const ::flatbuffers::TypeFunction type_refs[] = {
      keyfield::sample::ColorTypeTable};
  static const int64_t values[] = {0, 4, 20};
  static const char* const names[] = {"tag", "color"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_STRUCT,
                                              2,
                                              type_codes,
                                              type_refs,
...
inline const ::flatbuffers::TypeTable* FruitTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_SEQUENCE, 0, 0}, {::flatbuffers::ET_UCHAR, 0, -1}};
  static const ::flatbuffers::TypeFunction type_refs[] = {
...
inline const ::flatbuffers::TypeTable* RiceTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_UCHAR, 1, -1}, {::flatbuffers::ET_UINT, 0, -1}};
  static const int16_t array_sizes[] = {
      3,
  };
  static const int64_t values[] = {0, 4, 8};
  static const char* const names[] = {"origin", "quantity"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_STRUCT,
                                              2,
                                              type_codes,
                                              nullptr,
...
inline const ::flatbuffers::TypeTable* GrainTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_SEQUENCE, 1, 0}, {::flatbuffers::ET_UCHAR, 0, -1}};
  static const ::flatbuffers::TypeFunction type_refs[] = {
  ...
  static const char* const names[] = {"a", "tag"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_STRUCT,
                                              2,
                                              type_codes,
                                              type_refs,
...
inline const ::flatbuffers::TypeTable* FooTableTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_STRING, 0, -1},  {::flatbuffers::ET_SEQUENCE, 1, 0},
      {::flatbuffers::ET_SEQUENCE, 1, 1}, {::flatbuffers::ET_SEQUENCE, 1, 2},
      {::flatbuffers::ET_SEQUENCE, 1, 3}, {::flatbuffers::ET_SEQUENCE, 1, 4}};
  static const ::flatbuffers::TypeFunction type_refs[] = {
      keyfield::sample::BazTypeTable, keyfield::sample::BarTypeTable,
      keyfield::sample::AppleTypeTable, keyfield::sample::FruitTypeTable,
      keyfield::sample::GrainTypeTable};
  static const char* const names[] = {"a", "b", "c", "d", "e", "f", "g", "h"};
...
inline const keyfield::sample::FooTable* GetSizePrefixedFooTable(
    const void* buf) {
...
inline keyfield::sample::FooTable* GetMutableSizePrefixedFooTable(void* buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<keyfield::sample::FooTable>(
      buf);
}

inline bool VerifyFooTableBuffer(::flatbuffers::Verifier& verifier) {
...
inline std::unique_ptr<keyfield::sample::FooTableT> UnPackFooTable(
  ...
  return std::unique_ptr<keyfield::sample::FooTableT>(
      GetFooTable(buf)->UnPack(res));
}

inline std::unique_ptr<keyfield::sample::FooTableT> UnPackSizePrefixedFooTable(
    const void* buf, const ::flatbuffers::resolver_function_t* res = nullptr) {
  return std::unique_ptr<keyfield::sample::FooTableT>(
      GetSizePrefixedFooTable(buf)->UnPack(res));
}
