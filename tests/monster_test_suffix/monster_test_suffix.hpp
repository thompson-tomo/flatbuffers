...
inline const char* EnumNameLongEnum(LongEnum e) {
  switch (e) {
    case LongEnum_LongOne:
      return "LongOne";
    case LongEnum_LongTwo:
      return "LongTwo";
    case LongEnum_LongBig:
      return "LongBig";
    default:
      return "";
  }
...
template <>
struct AnyTraits<MyGame::Example::Monster> {
  static const Any enum_value = Any_Monster;
};

template <>
struct AnyTraits<MyGame::Example::TestSimpleTableWithEnum> {
...
template <>
struct AnyUnionTraits<MyGame::Example::MonsterT> {
  static const Any enum_value = Any_Monster;
};

template <>
struct AnyUnionTraits<MyGame::Example::TestSimpleTableWithEnumT> {
  static const Any enum_value = Any_TestSimpleTableWithEnum;
};

template <>
struct AnyUnionTraits<MyGame::Example2::MonsterT> {
  static const Any enum_value = Any_MyGame_Example2_Monster;
};
  ...
  switch (lhs.type) {
    ...
    case Any_TestSimpleTableWithEnum: {
      return *(reinterpret_cast<
                 const MyGame::Example::TestSimpleTableWithEnumT*>(
                 lhs.value)) ==
             *(reinterpret_cast<
...
inline const AnyUniqueAliases (&EnumValuesAnyUniqueAliases())[4] {
  static const AnyUniqueAliases values[] = {
      AnyUniqueAliases_NONE, AnyUniqueAliases_M, AnyUniqueAliases_TS,
      AnyUniqueAliases_M2};
  return values;
}
...
template <typename T>
struct AnyUniqueAliasesTraits {
  static const AnyUniqueAliases enum_value = AnyUniqueAliases_NONE;
};

template <>
struct AnyUniqueAliasesTraits<MyGame::Example::Monster> {
...
template <>
struct AnyUniqueAliasesTraits<MyGame::Example2::Monster> {
  static const AnyUniqueAliases enum_value = AnyUniqueAliases_M2;
};

template <typename T>
struct AnyUniqueAliasesUnionTraits {
  static const AnyUniqueAliases enum_value = AnyUniqueAliases_NONE;
};

template <>
struct AnyUniqueAliasesUnionTraits<MyGame::Example::MonsterT> {
  static const AnyUniqueAliases enum_value = AnyUniqueAliases_M;
};
...
template <>
struct AnyUniqueAliasesUnionTraits<MyGame::Example2::MonsterT> {
  static const AnyUniqueAliases enum_value = AnyUniqueAliases_M2;
};
...
inline const AnyAmbiguousAliases (&EnumValuesAnyAmbiguousAliases())[4] {
  static const AnyAmbiguousAliases values[] = {
      AnyAmbiguousAliases_NONE, AnyAmbiguousAliases_M1, AnyAmbiguousAliases_M2,
...
bool VerifyAnyAmbiguousAliases(::flatbuffers::Verifier& verifier,
...
inline H AbslHashValue(H h, const Vec3& obj) {
  return H::combine(std::move(h), obj.x(), obj.y(), obj.z(), obj.test1(),
                    obj.test2(), obj.test3());
}
...
struct InParentNamespace FLATBUFFERS_FINAL_CLASS
...
struct TestSimpleTableWithEnum FLATBUFFERS_FINAL_CLASS
  ...
  static ::flatbuffers::Offset<TestSimpleTableWithEnum> Pack(
      ::flatbuffers::FlatBufferBuilder& _fbb,
      const TestSimpleTableWithEnumT* _o,
      const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
};
...
struct TestSimpleTableWithEnumBuilder {
  ...
  explicit TestSimpleTableWithEnumBuilder(
      ::flatbuffers::FlatBufferBuilder& _fbb)
      : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct Monster FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  testarrayofstring() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<::flatbuffers::String>>*>(VT_TESTARRAYOFSTRING);
  }
  ...
  testarrayoftables() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<MyGame::Example::Monster>>*>(
  ...
  const ::flatbuffers::Vector<uint64_t>* vector_of_co_owning_references()
      const {
    return GetPointer<const ::flatbuffers::Vector<uint64_t>*>(
  ...
  const ::flatbuffers::Vector<uint64_t>* vector_of_non_owning_references()
      const {
    return GetPointer<const ::flatbuffers::Vector<uint64_t>*>(
  ...
  float nan_default() const {
    return GetField<float>(VT_NAN_DEFAULT,
                           std::numeric_limits<float>::quiet_NaN());
  }
  bool mutate_nan_default(
      float _nan_default = std::numeric_limits<float>::quiet_NaN()) {
    return SetField<float>(VT_NAN_DEFAULT, _nan_default,
                           std::numeric_limits<float>::quiet_NaN());
  }
  float inf_default() const {
    return GetField<float>(VT_INF_DEFAULT,
                           std::numeric_limits<float>::infinity());
  }
  bool mutate_inf_default(
      float _inf_default = std::numeric_limits<float>::infinity()) {
    return SetField<float>(VT_INF_DEFAULT, _inf_default,
                           std::numeric_limits<float>::infinity());
  }
  float positive_inf_default() const {
    return GetField<float>(VT_POSITIVE_INF_DEFAULT,
                           std::numeric_limits<float>::infinity());
  }
  bool mutate_positive_inf_default(
      float _positive_inf_default = std::numeric_limits<float>::infinity()) {
    return SetField<float>(VT_POSITIVE_INF_DEFAULT, _positive_inf_default,
                           std::numeric_limits<float>::infinity());
  }
  float infinity_default() const {
    return GetField<float>(VT_INFINITY_DEFAULT,
                           std::numeric_limits<float>::infinity());
  }
  bool mutate_infinity_default(
      float _infinity_default = std::numeric_limits<float>::infinity()) {
    return SetField<float>(VT_INFINITY_DEFAULT, _infinity_default,
                           std::numeric_limits<float>::infinity());
  }
  float positive_infinity_default() const {
    return GetField<float>(VT_POSITIVE_INFINITY_DEFAULT,
                           std::numeric_limits<float>::infinity());
  }
  bool mutate_positive_infinity_default(
      float _positive_infinity_default =
          std::numeric_limits<float>::infinity()) {
    return SetField<float>(VT_POSITIVE_INFINITY_DEFAULT,
                           _positive_infinity_default,
                           std::numeric_limits<float>::infinity());
  }
  float negative_inf_default() const {
    return GetField<float>(VT_NEGATIVE_INF_DEFAULT,
                           -std::numeric_limits<float>::infinity());
  }
  bool mutate_negative_inf_default(
      float _negative_inf_default = -std::numeric_limits<float>::infinity()) {
    return SetField<float>(VT_NEGATIVE_INF_DEFAULT, _negative_inf_default,
                           -std::numeric_limits<float>::infinity());
  }
  float negative_infinity_default() const {
    return GetField<float>(VT_NEGATIVE_INFINITY_DEFAULT,
                           -std::numeric_limits<float>::infinity());
  }
  bool mutate_negative_infinity_default(
      float _negative_infinity_default =
          -std::numeric_limits<float>::infinity()) {
    return SetField<float>(VT_NEGATIVE_INFINITY_DEFAULT,
                           _negative_infinity_default,
                           -std::numeric_limits<float>::infinity());
  }
  double double_inf_default() const {
    return GetField<double>(VT_DOUBLE_INF_DEFAULT,
                            std::numeric_limits<double>::infinity());
  }
  bool mutate_double_inf_default(
      double _double_inf_default = std::numeric_limits<double>::infinity()) {
    return SetField<double>(VT_DOUBLE_INF_DEFAULT, _double_inf_default,
                            std::numeric_limits<double>::infinity());
  }
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
...
inline ::flatbuffers::Offset<Monster> CreateMonsterDirect(
  ...
  return MyGame::Example::CreateMonster(
      ...
      nan_default, inf_default, positive_inf_default, infinity_default,
      positive_infinity_default, negative_inf_default,
      negative_infinity_default, double_inf_default);
}
...
inline bool operator==(const MonsterT& lhs, const MonsterT& rhs) {
  return ((lhs.pos == rhs.pos) ||
         ...
         (lhs.testarrayoftables.size() == rhs.testarrayoftables.size() &&
          std::equal(lhs.testarrayoftables.cbegin(),
                     lhs.testarrayoftables.cend(),
                     rhs.testarrayoftables.cbegin(),
                     [](std::unique_ptr<MyGame::Example::MonsterT> const& a,
                        std::unique_ptr<MyGame::Example::MonsterT> const& b) {
                       return (a == b) || (a && b && *a == *b);
                     })) &&
         ((lhs.enemy == rhs.enemy) ||
         ...
         (lhs.vector_of_referrables.size() ==
          ...
          std::equal(
              ...
              [](std::unique_ptr<MyGame::Example::ReferrableT> const& a,
                 std::unique_ptr<MyGame::Example::ReferrableT> const& b) {
                return (a == b) || (a && b && *a == *b);
              })) &&
         ...
         (lhs.scalar_key_sorted_tables.size() ==
          ...
          std::equal(lhs.scalar_key_sorted_tables.cbegin(),
                     lhs.scalar_key_sorted_tables.cend(),
                     rhs.scalar_key_sorted_tables.cbegin(),
                     [](std::unique_ptr<MyGame::Example::StatT> const& a,
                        std::unique_ptr<MyGame::Example::StatT> const& b) {
                       return (a == b) || (a && b && *a == *b);
                     })) &&
...
inline void Monster::UnPackTo(
  ...
  }
  {
    ...
    if (_e) {
      ...
      _o->testarrayofstring2.resize(0);
    }
  }
  {
    ...
    if (_e) {
      ...
      _o->testarrayofsortedstruct.resize(0);
    }
  }
  {
    auto _e = flex();
  ...
  }
  {
    ...
    } else if (_o->parent_namespace_test) {
      _o->parent_namespace_test.reset();
    }
  }
  {
    ...
    if (_e) {
      ...
      _o->vector_of_referrables.resize(0);
    }
  }
  {
  ...
  }
  {
    ...
    if (_e) {
      ...
      _o->vector_of_weak_references.resize(0);
    }
  }
  {
    ...
    if (_e) {
      ...
      _o->vector_of_strong_referrables.resize(0);
    }
  }
  {
  ...
  }
  {
    ...
    if (_e) {
      ...
      for (::flatbuffers::uoffset_t _i = 0; _i < _e->size();
        ...
        if (_resolver)
          (*_resolver)(
              reinterpret_cast<void**>(&_o->vector_of_co_owning_references[_i]),
              static_cast<::flatbuffers::hash_value_t>(
                  _e->Get(_i))); /* else do nothing */
      }
    } else {
      _o->vector_of_co_owning_references.resize(0);
    }
  }
  {
  ...
  }
  {
    ...
    if (_e) {
      ...
      _o->vector_of_non_owning_references.resize(0);
    }
  }
  {
  ...
  }
  {
    ...
    if (_e) {
      ...
      _o->scalar_key_sorted_tables.resize(0);
    }
  }
  {
  ...
  {
    auto _e = positive_inf_default();
    _o->positive_inf_default = _e;
  }
  {
    auto _e = infinity_default();
    _o->infinity_default = _e;
  }
  {
    auto _e = positive_infinity_default();
    _o->positive_infinity_default = _e;
  }
  {
    auto _e = negative_inf_default();
    _o->negative_inf_default = _e;
  }
  {
    auto _e = negative_infinity_default();
    _o->negative_infinity_default = _e;
  }
  {
    auto _e = double_inf_default();
    _o->double_inf_default = _e;
  }
}
...
inline ::flatbuffers::Offset<Monster> CreateMonster(
  ...
  return MyGame::Example::CreateMonster(
      ...
      _nan_default, _inf_default, _positive_inf_default, _infinity_default,
      _positive_infinity_default, _negative_inf_default,
      _negative_infinity_default, _double_inf_default);
}
...
inline const ::flatbuffers::TypeTable* AnyTypeTable() {
  ...
  static const char* const names[] = {
      "NONE", "Monster", "TestSimpleTableWithEnum", "MyGame_Example2_Monster"};
...
inline const ::flatbuffers::TypeTable* Vec3TypeTable() {
  ...
  static const char* const names[] = {"x", "y", "z", "test1", "test2", "test3"};
...
inline const ::flatbuffers::TypeTable* TypeAliasesTypeTable() {
  ...
  static const char* const names[] = {"i8",  "u8",  "i16", "u16",
                                      "i32", "u32", "i64", "u64",
                                      "f32", "f64", "v8",  "vf64"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_TABLE,
                                              12,
...
inline MyGame::Example::Monster* GetMutableSizePrefixedMonster(void* buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<MyGame::Example::Monster>(
      buf);
}
