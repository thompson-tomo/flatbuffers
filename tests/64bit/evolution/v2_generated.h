...
struct RootTable FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_a(float _a = 0.0f) { return SetField<float>(VT_A, _a, 0.0f); }
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_B) && verifier.VerifyVector(b()) &&
           VerifyOffset64(verifier, VT_BIG_VECTOR) &&
           verifier.VerifyVector(big_vector()) && verifier.EndTable();
  }
  RootTableT* UnPack(
...
struct RootTableBuilder {
  ...
  void add_a(float a) { fbb_.AddElement<float>(RootTable::VT_A, a, 0.0f); }
...
inline ::flatbuffers::Offset<RootTable> CreateRootTable(
    ::flatbuffers::FlatBufferBuilder64& _fbb, float a = 0.0f,
...
inline ::flatbuffers::Offset<RootTable> CreateRootTableDirect(
  ...
  return v2::CreateRootTable(_fbb, a, b__, big_vector__);
}
...
inline void RootTable::UnPackTo(
  ...
  }
  {
    ...
    if (_e) {
      _o->b.resize(_e->size());
      std::copy(_e->begin(), _e->end(), _o->b.begin());
    }
  }
  {
    auto _e = big_vector();
...
inline ::flatbuffers::Offset<RootTable> CreateRootTable(
  ...
  return v2::CreateRootTable(_fbb, _a, _b, _big_vector);
}
...
inline const ::flatbuffers::TypeTable* RootTableTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_UCHAR, 1, -1}};
  static const char* const names[] = {"a", "b", "big_vector"};
...
inline const v2::RootTable* GetSizePrefixedRootTable(const void* buf) {
  return ::flatbuffers::GetSizePrefixedRoot<v2::RootTable,
...
inline v2::RootTable* GetMutableSizePrefixedRootTable(void* buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<v2::RootTable,
...
inline bool VerifySizePrefixedRootTableBuffer(
  ...
  return verifier
      .VerifySizePrefixedBuffer<v2::RootTable, ::flatbuffers::uoffset64_t>(
          nullptr);
}
...
inline std::unique_ptr<v2::RootTableT> UnPackSizePrefixedRootTable(
    const void* buf, const ::flatbuffers::resolver_function_t* res = nullptr) {
  return std::unique_ptr<v2::RootTableT>(
