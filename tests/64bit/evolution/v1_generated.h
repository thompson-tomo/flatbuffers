...
struct RootTable FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  static ::flatbuffers::Offset<RootTable> Pack(
      ::flatbuffers::FlatBufferBuilder& _fbb, const RootTableT* _o,
...
inline ::flatbuffers::Offset<RootTable> CreateRootTable(
    ::flatbuffers::FlatBufferBuilder& _fbb, float a = 0.0f,
...
inline ::flatbuffers::Offset<RootTable> CreateRootTableDirect(
  ...
  return v1::CreateRootTable(_fbb, a, b__);
}
...
inline ::flatbuffers::Offset<RootTable> CreateRootTable(
  ...
  return v1::CreateRootTable(_fbb, _a, _b);
}

inline const ::flatbuffers::TypeTable* RootTableTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_FLOAT, 0, -1}, {::flatbuffers::ET_UCHAR, 1, -1}};
...
inline void FinishRootTableBuffer(::flatbuffers::FlatBufferBuilder& fbb,
...
inline std::unique_ptr<v1::RootTableT> UnPackSizePrefixedRootTable(
    const void* buf, const ::flatbuffers::resolver_function_t* res = nullptr) {
  return std::unique_ptr<v1::RootTableT>(
