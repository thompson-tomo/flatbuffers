...
inline ApplicationDataT& ApplicationDataT::operator=(ApplicationDataT o)
...
inline void ApplicationData::UnPackTo(
  ...
  }
  {
    ...
    if (_e) {
      ...
      _o->vectors_alt.resize(0);
    }
  }
  {
    auto _e = position();
    if (_e)
      _o->position = std::unique_ptr<Native::Vector3D>(
          new Native::Vector3D(::flatbuffers::UnPack(*_e)));
  }
  {
    auto _e = position_inline();
    if (_e) _o->position_inline = ::flatbuffers::UnPack(*_e);
  }
}
...
inline ::flatbuffers::Offset<ApplicationData> CreateApplicationData(
  ...
  auto _vectors_alt =
      _o->vectors_alt.size()
          ...
          : 0;
  auto _position = Geometry::Vector3D{};
  if (_o->position) _position = ::flatbuffers::Pack(*_o->position);
...
inline const ::flatbuffers::TypeTable* ApplicationDataTypeTable() {
  ...
  static const char* const names[] = {"vectors", "vectors_alt", "position",
                                      "position_inline"};
...
inline std::unique_ptr<Geometry::ApplicationDataT> UnPackApplicationData(
  ...
  return std::unique_ptr<Geometry::ApplicationDataT>(
      GetApplicationData(buf)->UnPack(res));
}

inline std::unique_ptr<Geometry::ApplicationDataT>
