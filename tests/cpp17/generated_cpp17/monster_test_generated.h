...
inline const char* EnumNameLongEnum(LongEnum e) {
  switch (e) {
    case LongEnum::LongOne:
      return "LongOne";
    case LongEnum::LongTwo:
      return "LongTwo";
    case LongEnum::LongBig:
      return "LongBig";
    default:
      return "";
  }
...
inline const AnyUniqueAliases (&EnumValuesAnyUniqueAliases())[4] {
  static const AnyUniqueAliases values[] = {
      AnyUniqueAliases::NONE, AnyUniqueAliases::M, AnyUniqueAliases::TS,
      AnyUniqueAliases::M2};
  return values;
}
...
inline const char* EnumNameAnyUniqueAliases(AnyUniqueAliases e) {
  if (::flatbuffers::IsOutRange(e, AnyUniqueAliases::NONE,
                                AnyUniqueAliases::M2))
    return "";
  const size_t index = static_cast<size_t>(e);
...
inline const AnyAmbiguousAliases (&EnumValuesAnyAmbiguousAliases())[4] {
  static const AnyAmbiguousAliases values[] = {
      AnyAmbiguousAliases::NONE, AnyAmbiguousAliases::M1,
      AnyAmbiguousAliases::M2, AnyAmbiguousAliases::M3};
  return values;
}
 ...
 public:
  ...
  auto get_field() const {
    if constexpr (Index == 0)
      ...
      static_assert(Index != -1, "Invalid Field Index");
  }
};
...
struct Test::Traits {
  ...
  static constexpr std::array<const char*, fields_number> field_names = {"a",
                                                                         "b"};
  template <size_t Index>
...
struct Referrable::Traits {
  ...
  static constexpr size_t fields_number = 1;
  static constexpr std::array<const char*, fields_number> field_names = {"id"};
  template <size_t Index>
  using FieldType = decltype(std::declval<type>().get_field<Index>());
};
