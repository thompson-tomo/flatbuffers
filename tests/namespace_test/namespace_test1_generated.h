...
template <typename T>
struct UnionInNestedNSUnionTraits {
  static const UnionInNestedNS enum_value = UnionInNestedNS_NONE;
};
  ...
  switch (lhs.type) {
    ...
    case UnionInNestedNS_TableInNestedNS: {
      return *(reinterpret_cast<
                 const NamespaceA::NamespaceB::TableInNestedNST*>(lhs.value)) ==
             *(reinterpret_cast<
...
inline const char* EnumNameEnumInNestedNS(EnumInNestedNS e) {
  if (::flatbuffers::IsOutRange(e, EnumInNestedNS_A, EnumInNestedNS_C))
    return "";
  const size_t index = static_cast<size_t>(e);
...
inline bool VerifyUnionInNestedNS(::flatbuffers::Verifier& verifier,
  ...
  switch (type) {
    ...
    case UnionInNestedNS_TableInNestedNS: {
      auto ptr =
          reinterpret_cast<const NamespaceA::NamespaceB::TableInNestedNS*>(obj);
