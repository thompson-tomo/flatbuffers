...
struct TableInFirstNSBuilder {
  ...
  void add_foo_table(
      ::flatbuffers::Offset<NamespaceA::NamespaceB::TableInNestedNS>
          foo_table) {
...
inline void TableInFirstNS::UnPackTo(
  ...
  (void)_resolver;
  {
    ...
    if (_e) {
      if (_o->foo_table) {
        ...
        _o->foo_table =
            std::unique_ptr<NamespaceA::NamespaceB::TableInNestedNST>(
                _e->UnPack(_resolver));
      }
    } else if (_o->foo_table) {
      _o->foo_table.reset();
    }
  }
  {
  ...
  }
  {
    ...
    if (_e)
      _o->foo_struct =
          std::unique_ptr<NamespaceA::NamespaceB::StructInNestedNS>(
  ...
  (void)_resolver;
  {
    ...
    if (_e) {
      if (_o->refer_to_a1) {
        ...
        _o->refer_to_a1 =
            std::unique_ptr<NamespaceA::TableInFirstNST>(_e->UnPack(_resolver));
      }
    } else if (_o->refer_to_a1) {
      _o->refer_to_a1.reset();
    }
  }
  {
    auto _e = refer_to_a2();
    if (_e) {
      if (_o->refer_to_a2) {
        ...
        _o->refer_to_a2 =
            std::unique_ptr<NamespaceA::SecondTableInAT>(_e->UnPack(_resolver));
      }
    } else if (_o->refer_to_a2) {
      _o->refer_to_a2.reset();
    }
  }
}
  ...
  (void)_resolver;
  {
    ...
    if (_e) {
      if (_o->refer_to_c) {
        ...
        _o->refer_to_c =
            std::unique_ptr<NamespaceC::TableInCT>(_e->UnPack(_resolver));
      }
    } else if (_o->refer_to_c) {
      _o->refer_to_c.reset();
    }
  }
}
...
inline const ::flatbuffers::TypeTable* TableInFirstNSTypeTable() {
  ...
  static const char* const names[] = {"foo_table", "foo_enum", "foo_union_type",
                                      "foo_union", "foo_struct"};
