...
inline const Character (&EnumValuesCharacter())[7] {
  static const Character values[] = {
      Character_NONE,    Character_MuLan, Character_Rapunzel, Character_Belle,
      Character_BookFan, Character_Other, Character_Unused};
  return values;
}

inline const char* const* EnumNamesCharacter() {
  static const char* const names[8] = {"NONE",    "MuLan", "Rapunzel", "Belle",
                                       "BookFan", "Other", "Unused",   nullptr};
  return names;
}
...
struct CharacterUnion {
  ...
  const Rapunzel* AsRapunzel() const {
    return type == Character_Rapunzel ? reinterpret_cast<const Rapunzel*>(value)
                                      : nullptr;
  }
  BookReader* AsBelle() {
  ...
  const std::string* AsOther() const {
    return type == Character_Other ? reinterpret_cast<const std::string*>(value)
                                   : nullptr;
  }
  std::string* AsUnused() {
...
template <>
struct GadgetTraits<FallingTub> {
  static const Gadget enum_value = Gadget_FallingTub;
};

template <>
struct GadgetTraits<HandFan> {
...
template <>
struct GadgetUnionTraits<FallingTub> {
  static const Gadget enum_value = Gadget_FallingTub;
};

template <>
struct GadgetUnionTraits<HandFanT> {
  static const Gadget enum_value = Gadget_HandFan;
};
...
inline bool VerifyCharacter(::flatbuffers::Verifier& verifier, const void* obj,
  ...
  switch (type) {
    ...
    case Character_Rapunzel: {
      return verifier.VerifyField<Rapunzel>(static_cast<const uint8_t*>(obj), 0,
                                            4);
    }
    case Character_Belle: {
...
inline const ::flatbuffers::TypeTable* CharacterTypeTable() {
  ...
  static const ::flatbuffers::TypeFunction type_refs[] = {
      AttackerTypeTable, RapunzelTypeTable, BookReaderTypeTable};
