...
struct FieldBuilder {
  ...
  void add_offset64(bool offset64) {
    fbb_.AddElement<uint8_t>(Field::VT_OFFSET64, static_cast<uint8_t>(offset64),
                             0);
  }
  ...
  auto documentation__ =
      documentation
          ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(
                *documentation)
          : 0;
  return reflection::CreateField(_fbb, name__, type, id, offset,
                                 default_integer, default_real, deprecated,
                                 required, key, attributes__, documentation__,
                                 optional, padding, offset64);
}
...
struct Schema FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  objects() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<reflection::Object>>*>(VT_OBJECTS);
  }
